...
![Tech stack](../../assets/img/Picture1.png){: style="width: 60%; height: auto;" }

## Example Visualizations Generated by MEAnalysis

![Tech stack](../../assets/img/Plate_1_DIV_18_30_Min.png){: style="width: 100%; height: auto;" }
...
![Tech stack](../../assets/img/Number of Spikes.png){: style="width: 100%; height: auto;" }
...
![Tech stack](../../assets/img/Plate 1 Min 30.png){: style="width: 100%; height: auto;" }
Significance table showing the p-value from t-test between average measurement of each metric’s control and treatments

![Tech stack](../../assets/img/Plate 1 DIV 12 Min 5 Bursts.png){: style="width: 100%; height: auto;" }
